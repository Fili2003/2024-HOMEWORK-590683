...
public class LabirintoBuilderTest2 {
	...
	public void testBilocale() {
		...
		List<String> direzioniIniziale = new LinkedList<String>(bilocale.getStanzaIniziale().getDirezioni());
		List<String> direzioniVincente = new LinkedList<String>(bilocale.getStanzaVincente().getDirezioni());
		assertEquals(Collections.singletonList("nord"), direzioniIniziale);
		assertEquals(Collections.singletonList("sud"), direzioniVincente);
	}
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		assertNotEquals(stanzaVincente, labirintoBuilder.getStanze().get("stanza bloccata").getStanzaAdiacente("nord"));
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertNotEquals(stanzaBloccata, labirintoBuilder.getStanze().get("stanza bloccata").getStanzaAdiacente("nord"));
	}
